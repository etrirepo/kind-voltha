...
export VOLTHA_CHART_VERSION="2.5.7"
...
export VOLTHA_ADAPTER_OPEN_OLT_CHART_VERSION="2.5.10"
export VOLTHA_ADAPTER_OPEN_ONU_CHART="onf/voltha-adapter-openonu"
export VOLTHA_ADAPTER_OPEN_ONU_CHART_VERSION="2.4.6"
